...
<body>
	...
	<form action="qaEditok.inc" method="post" encType="multipart/form-data" name="edit_frm">
		<table summary="게시판 수정" style="margin: auto; width:740px;">
			<tbody>
				<tr>
					...
					<td><input type="text" id="subject" name="subject" size="45" value="${qvo.subject}"/>  </td>
				</tr>
				<tr>
					<th style="background-color:#669AB3;"><label for="writer">이름:</label></th>
					<td><input type="text" id="writer" name="writer" size="12" value="${ qvo.writer }"/> </td>
				</tr>
				<tr>
					<th style="background-color:#669AB3;"><label for="file">첨부파일:</label></th>
					<td><input type="file" id="file" name="file"/>(${ qvo.file_name })</td>
				</tr>
		...
		<input type="hidden" name="nowPage" value="${ qanowPage}"/>
		...
		<table style="margin: auto; width:740px;">
			<tbody>
				<tr>
					...
					<td><textarea name="content" cols="50" rows="8" id="content" >${ qvo.content }</textarea>
					</td>
				</tr>
				<tr>
   ...
   <script type="text/javascript">
		$(function(){
			$("#list").bind("click",function(){
				...
				location.href= "qanotice.inc?nowPage=${qanowPage }";
