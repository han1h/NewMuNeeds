...
public class KakaoAPI {
    ...
    public String getAccessToken (String authorize_code) {
        ...
        try {
            ...
            sb.append("&client_id=3721f9c5859cad5e297bf53dc38333ac");
            sb.append("&redirect_uri=http://localhost:9090/berhmkorea/kakaologin.inc");
...
public HashMap<String, Object> getUserInfo (String access_Token) {
    ...
    try {
        ...
        String nickname = properties.getAsJsonObject().get("nickname").getAsString().toString();
        String email = null;
