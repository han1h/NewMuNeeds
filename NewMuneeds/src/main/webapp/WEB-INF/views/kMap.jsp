...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=51f0a335a23c50c2efda429ebe85d84e"></script>
<script>
...
$(function(){
	var addr = $("#fr").val();
	 ...
	 $.ajax({
		 url: "kaj.inc?dt="+encodeURIComponent(addr),
		 type: "GET",
		 dataType:"json"
	 }).done(function(data){
		 if(data.addr!= null){
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = {
        center: new kakao.maps.LatLng(37.529731, 126.836069), // 지도의 중심좌표
        level: 1 // 지도의 확대 레벨
    };  
...
var markerPosition  = new kakao.maps.LatLng(37.529731, 126.836069); 
